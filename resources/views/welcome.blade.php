...
<html lang="en">
    ...
    <body data-spy="scroll" data-target="#template-navbar">
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            <ul id="menu-pricing" class="menu-price">
                                @foreach ($items as $item)
                                    ...
                                    <a href="#">
                                        <img src="{{ asset('uploads/item/'.$item->image) }}" class="img-responsive" alt="Food" style="width: 300px; heigth: 369px;" >
                                ...
                                <form class="reservation-form" method="post" action="{{ route('reserve') }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control reserve-form empty iconified" name="datepicker" id="datetimepicker" placeholder="&#xf017;  Time">
                                            </div>
                                        </div>
        ...
        <script src="{{ asset('public/frontend/js/jquery.hoverdir.js') }}"></script>
        <script src="{{ asset('public/frontend/js/jQuery.scrollSpeed.js') }}"></script>
